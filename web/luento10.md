...
Java 8:ssa kokoelimille on lisätty metodi <code>forEach</code>, jonka avulla kokoelma on helppo käydä läpi. Metodille voidaan antaa parametriksi _lambda-lauseke_ jota metodi kutsuu jokaiselle kokoelman alkiolle:
